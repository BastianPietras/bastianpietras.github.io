...
A single neuron is uniquely characterized through the probability to spike in the next instant in time, given its age (i.e. the time elapsed since its last spike) and some input.
